...
def tif2cog(input_paths: List[Path], suffix: str, type: str, value_type: str="category") -> None:
    for input_path in input_paths:
        print(f"Converting: {input_path}")
        output_cog_path = input_path.with_name(f"{input_path.stem}-{suffix}{input_path.suffix}")
